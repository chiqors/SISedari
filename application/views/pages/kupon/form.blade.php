...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{ @$info ? 'Edit' : 'Create' }} Kupon <small></small></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="{{ site_url('') }}">Dashboard</a></li>
					<li class="breadcrumb-item"><a href="{{ site_url('kupon') }}">Kupon</a></li>
                    <li class="breadcrumb-item active">{{ @$info ? 'Edit' : 'Create' }} Kupon</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    <div class="container-fluid">
        <form role="form" action="{{ @$info ? site_url('kupon/edit/1') : site_url('kupon/store') }}" enctype="multipart/form-data" method="POST">
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
