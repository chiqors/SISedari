                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row">
								<div class="col-sm-6">
									<div class="row">
										<a href="{{ site_url('manager/transaksi/create') }}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> New Transaksi</a>
									</div>
								</div>
								<div class="col-sm-6">
									...
									<td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item nav-show" href="{{ site_url('manager/transaksi/show/1') }}"><i
                                                    class="fa fa-eye"></i> Show</a>
                                                <a class="dropdown-item nav-warning" href="{{ site_url('manager/transaksi/edit/1') }}"><i
                                                    class="fa fa-edit"></i> Edit</a>
												<a class="dropdown-item nav-danger" href="{{ site_url('manager/transaksi/destroy/1') }}"><i 
