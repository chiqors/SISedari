                        ...
                        <table id="table-data" class="table table-bordered table-striped text-center table-responsive-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<td>
										<a href="{{ site_url('ceo/pengguna/show/'.$info_data->nip) }}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Tampil</a> | 
										<a href="{{ site_url('ceo/pengguna/edit/'.$info_data->nip) }}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Ubah</a> | 
										<a href="{{ site_url('ceo/pengguna/destroy/'.$info_data->nip) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
								</tr>
								@endforeach
                            </tbody>
