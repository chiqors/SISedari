        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Data Kupon</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row">
								<div class="col-sm-6">
									<div class="row">
										<a href="{{ site_url('manager/kupon/create') }}" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> Tambah Kupon</a>
									</div>
								</div>
								<div class="col-sm-6">
