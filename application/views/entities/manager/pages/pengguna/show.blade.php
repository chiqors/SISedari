            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <div class="card-footer">
						<a class="btn btn-warning" href="{{ site_url('manager/pengguna/edit/'.$info->nip) }}"><i class="fa fa-edit"></i> Ubah</a>
						<a class="btn btn-danger" href="{{ site_url('manager/pengguna/destroy/'.$info->nip) }}"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
                </div>
            </div>
        </div>
