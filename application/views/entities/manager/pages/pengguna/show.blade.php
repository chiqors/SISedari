            ...
            <div class="col-md-12">
                <div class="card card-primary">
                            ...
                            <div class="col-md-12">
                                <table class="table table-user-information">
                                    <tbody>
										...
										<tr>
											<td>Password</td>
											<td><button class="btn btn-info btn-xs show-pw"><i class="fa fa-eye"></i> Tampil</button></td>
										</tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="card-footer">
						<a class="btn btn-warning" href="{{ site_url('manager/pengguna/edit/1') }}"><i class="fa fa-edit"></i> Ubah</a>
						<a class="btn btn-danger" href="{{ site_url('manager/pengguna/destroy/1') }}"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
                </div>
            </div>
        </div>
